...
def index():
    ...
    return render_template(
        'index.html',
        posts=posts,
        title='DevBlog - Mi Blog Personal'
    )
...
def create_post():
    """
    Crear nuevo post - Maneja tanto GET (mostrar formulario)
    como POST (procesar formulario)
    """
...
def search():
    ...
    return render_template(
        ...
        if query else 'Búsqueda - DevBlog'
    )
